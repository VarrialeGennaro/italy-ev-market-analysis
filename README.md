...
Descrizione:
Questo progetto contiene un'analisi dell'andamento delle immatricolazioni di auto elettriche in Italia dal 2014 al 2025, basata su dati ufficiali UNRAE.
...
Aggiornamento: Analisi Predittiva (2026-2028)
...
Analisi dei margini: Il nuovo grafico include limiti di confidenza (scenario ottimistico e pessimistico) per contestualizzare la variabilità e l'incertezza intrinseca del mercato.

Dataset integrato: Il file Excel è stato aggiornato con un foglio dedicato ai calcoli previsionali, rendendo l'intero modello trasparente e verificabile.

Anteprima:

![Grafico Finale](italy-ev-market-analysis/docs/grafico_previsione.jpg).
